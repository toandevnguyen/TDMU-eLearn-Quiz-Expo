...
export default function IndexDocsScreen({ navigation }) {
  return (
    // <Container isScroll>
    <View style={styles.categoryContainer}>
      ...
      <TouchableOpacity
        style={styles.category}
        onPress={() =>
          navigation.navigate("LecturersScreen", 
      ...
      <TouchableOpacity
        style={styles.category}
        onPress={() =>
          navigation.navigate("LecturersScreen", { category: "Kinh tế chính trị" })
        }
      >
      ...
      <TouchableOpacity
        style={styles.category}
        onPress={() =>
          navigation.navigate("LecturersScreen", { category: "Triết học" })
        }
      >
      ...
      <TouchableOpacity
        style={styles.category}
        onPress={() =>
          navigation.navigate("LecturersScreen", { category: "Lịch sử Đảng" })
        }
      >
